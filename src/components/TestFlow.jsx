...
//       pan: "ABCDE1234F",
//       glcode: "GL00123",
//       start_date: "2025-09-26", // will show calendar
//     };
//     setApiData(responseFromAPI);
//     setIsDrawerOpen(true);
//   };
...
//   // Generate JSON Schema dynamically from API data
...
//         return [key, { type, title: key.replace(/_/g, " "), default: value, format }];
//       })
//     ),
//   });

//   // UI Schema to show date pickers for date fields
//   const generateUiSchema = (data) =>
//     Object.fromEntries(
//       Object.entries(data)
//         .filter(([_, value]) => /\d{4}-\d{2}-\d{2}/.test(value))
//         .map(([key]) => [key, { "ui:widget": "date" }])
//     );
...
//         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-x-15 gap-y-8 mt-8 justify-center place-items-center">
//           <Step
//             header="O2CGoodsBaseTest"
//             lastDate="2025-09-01"
//             value={50}
...
//       {/* Drawer with dynamic JSON Schema Form */}
//       <Drawer isOpen={isDrawerOpen} onClose={() => setIsDrawerOpen(false)}>
//         {Object.keys(apiData).length > 0 ? (
...
//             <Form
//               schema={generateSchema(apiData)}
//               uiSchema={generateUiSchema(apiData)}
//               validator={ajv} // ✅ Important to prevent the validator error
//               onSubmit={({ formData }) => {
