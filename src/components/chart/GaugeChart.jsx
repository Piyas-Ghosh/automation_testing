...
//     root.autoResize = true;     // make chart responsive
...
//       am5xy.ValueAxis.new(root, { min: -40, max: 100, strictMinMax: true, renderer: axisRenderer })
//     );

//     // Make axis labels (high/low scores) white
...
//   return (
//     <div id="gaugeChartDiv" className="w-full h-[300px] md:h-[400px]" />
//   );
// }
import { useLayoutEffect } from "react";
import * as am5 from "@amcharts/amcharts5";
...
export default function GaugeChart() {
  useLayoutEffect(() => {
    ...
    root.autoResize = true;     // responsive
